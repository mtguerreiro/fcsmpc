...
//#define TLVSI_CONFIG_k2_int		((int64_t)(TLVSI_CONFIG_k2 * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_k3_int		((int64_t)(TLVSI_CONFIG_k3 * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_k4_int		((int64_t)(TLVSI_CONFIG_k4 * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_k5_int		((int64_t)(TLVSI_CONFIG_k5 * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_k6_int		((int64_t)(TLVSI_CONFIG_k6 * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_k7_int		((int64_t)(TLVSI_CONFIG_k7 * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_k8_int		((int64_t)(TLVSI_CONFIG_k8 * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_k9_int		((int64_t)(TLVSI_CONFIG_k9 * TLVSI_CONFIG_FTOI_K))
//
//#define TLVSI_CONFIG_w_ii_int		((int64_t)(TLVSI_CONFIG_w_ii * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_w_ig_int		((int64_t)(TLVSI_CONFIG_w_ig * TLVSI_CONFIG_FTOI_K))
//#define TLVSI_CONFIG_w_vc_int		((int64_t)(TLVSI_CONFIG_w_vc * TLVSI_CONFIG_FTOI_K))
...
//        co = (int64_t)(TLVSI_CONFIG_FTOI_K * cosf(theta));
//        si = (int64_t)(TLVSI_CONFIG_FTOI_K * sinf(theta));
//
